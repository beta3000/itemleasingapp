(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@angular/material'), require('@covalent/core')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', '@angular/material', '@covalent/core'], factory) :
    (factory((global.td = global.td || {}, global.td.dynamicForms = global.td.dynamicForms || {}),global.ng.core,global.ng.common,global.ng.forms,global.ng.material,global.td.core));
}(this, (function (exports,_angular_core,_angular_common,_angular_forms,_angular_material,_covalent_core) { 'use strict';
...
(function (TdDynamicElement) {
    ...
    TdDynamicElement[TdDynamicElement["Password"] = 'password'] = "Password";
...
var TdDynamicFormsService = (function () {
    ...
    TdDynamicFormsService.prototype.getDynamicElement = function (element) {
        switch (element) {
            ...
            case exports.TdDynamicElement.Password:
    ...
    TdDynamicFormsService.prototype.createValidators = function (config) {
        var validator;
        if (config.required) {
            validator = _angular_forms.Validators.required;
        }
        if (config.max || config.max === 0) {
            validator = _angular_forms.Validators.compose([validator, _angular_forms.Validators.max(parseFloat(config.max))]);
        }
        if (config.min || config.min === 0) {
            validator = _angular_forms.Validators.compose([validator, _angular_forms.Validators.min(parseFloat(config.min))]);
        }
        return validator;
    };
...
var DYNAMIC_FORMS_PROVIDER = {
    ...
    deps: [[new _angular_core.Optional(), new _angular_core.SkipSelf(), TdDynamicFormsService]],
...
exports.CovalentDynamicFormsModule = (function () {
    function CovalentDynamicFormsModule() {
    }
    return CovalentDynamicFormsModule;
}());
exports.CovalentDynamicFormsModule = __decorate([
    _angular_core.NgModule({
        ...
        imports: [
            ...
            _covalent_core.CovalentCommonModule,
        ],
        exports: [
            TD_DYNAMIC_FORMS,
            TD_DYNAMIC_FORMS_ENTRY_COMPONENTS,
